...
function Hero() {
  return (
    <section id="home" className="bg-black flex flex-col w-full md:flex-row items-center gap-10 md:gap-28 px-4 md:px-12 py-20 scroll-mt-24 border-b border-gray-700">
      {/* Hero Text */}
